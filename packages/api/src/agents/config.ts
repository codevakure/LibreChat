import { EModelEndpoint, agentsEndpointSchema } from 'wrangler-data-provider';
import type { TCustomConfig, TAgentsEndpoint } from 'wrangler-data-provider';

/**
 * Sets up the Agents configuration from the config (`wrangler.yaml`) file.
