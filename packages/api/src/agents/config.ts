import { EModelEndpoint, agentsEndpointSchema } from 'pleach-data-provider';
import type { TCustomConfig, TAgentsEndpoint } from 'pleach-data-provider';

/**
 * Sets up the Agents configuration from the config (`pleach.yaml`) file.
