import { extractPleachParams } from './llm';

describe('extractPleachParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractPleachParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractPleachParams();
  ...
  it('should extract all Pleach params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractPleachParams(options);
  ...
  it('should handle null values for Pleach params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known Pleach params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should not mutate the original options object', () => {
    ...
    extractPleachParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional Pleach params', () => {
    const options = {
      resendFiles: false,
