# Dynamic Theme System for @pleach/client
...
```bash
npm install @pleach/client
```

### 2. Wrap Your App with ThemeProvider

```tsx
import { ThemeProvider } from '@pleach/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@pleach/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@pleach/client';
...
```tsx
import { useTheme } from '@pleach/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@pleach/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@pleach/client';
...
This theme system is part of the @pleach/client package. 