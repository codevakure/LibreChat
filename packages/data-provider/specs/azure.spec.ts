...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'pleach-westus'
    expect(groupMap).toHaveProperty('pleach-westus');
    expect(groupMap['pleach-westus']).toEqual(
    ...
    // Check groupMap for 'pleach-eastus'
    expect(groupMap).toHaveProperty('pleach-eastus');
    expect(groupMap['pleach-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'pleach-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'pleach-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'pleach-eastus',
