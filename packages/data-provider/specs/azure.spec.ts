...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'wrangler-westus'
    expect(groupMap).toHaveProperty('wrangler-westus');
    expect(groupMap['wrangler-westus']).toEqual(
    ...
    // Check groupMap for 'wrangler-eastus'
    expect(groupMap).toHaveProperty('wrangler-eastus');
    expect(groupMap['wrangler-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'wrangler-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'wrangler-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'wrangler-eastus',
