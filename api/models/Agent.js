...
const { ResourceType, SystemRoles, Tools, actionDelimiter } = require('wrangler-data-provider');
const { GLOBAL_PROJECT_NAME, EPHEMERAL_AGENT_ID, mcp_all, mcp_delimiter } =
  require('wrangler-data-provider').Constants;
const {
 ...
 * @param {import('@wrangler/agents').ClientOptions} [params.model_parameters]
 * @returns {Promise<Agent|null>} The agent document as a plain object, or null if not found.
 */
