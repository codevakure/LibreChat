...
const { agentSchema } = require('@wrangler/data-schemas');
...
/**
 * @type {import('mongoose').Model<import('@wrangler/data-schemas').IAgent>}
 */
let Agent;
...
describe('models/Agent', () => {
  ...
  describe('Agent CRUD Operations', () => {
    ...
    test('should handle ephemeral agent loading', async () => {
      ...
      const originalModule = jest.requireActual('wrangler-data-provider');
      ...
      jest.doMock('wrangler-data-provider', () => mockDataProvider);

      expect(agentId).toBeDefined();
      expect(endpoint).toBeDefined();

      jest.dontMock('wrangler-data-provider');
    });
  ...
  describe('Load Agent Functionality', () => {
    ...
    test('should test ephemeral agent loading logic', async () => {
      const { EPHEMERAL_AGENT_ID } = require('wrangler-data-provider').Constants;
