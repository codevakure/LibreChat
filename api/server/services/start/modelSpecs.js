...
/**
 * Sets up Model Specs from the config (`pleach.yaml`) file.
...
For more information, see the documentation at https://www.pleach.ai/docs/configuration/pleach_yaml/object_structure/model_specs#endpoint`);
      continue;
    }
