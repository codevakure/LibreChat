...
const { getTransactionSupport, logger } = require('@pleach/data-schemas');
const { ResourceType, PrincipalType, PrincipalModel } = require('pleach-data-provider');
const {
...
/**
 * @import { TPrincipal } from 'pleach-data-provider'
 */
/**
