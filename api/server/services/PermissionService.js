...
const { getTransactionSupport, logger } = require('@wrangler/data-schemas');
const { ResourceType, PrincipalType, PrincipalModel } = require('wrangler-data-provider');
const {
...
/**
 * @import { TPrincipal } from 'wrangler-data-provider'
 */
/**
