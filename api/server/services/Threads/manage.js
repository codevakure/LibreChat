 ...
 * @param {import('wrangler-data-provider').TFile[]} [params.files] - Optional. List of Attached File Objects.
...
/**
 * Records Wrangler messageId to all response messages' metadata
 *
 * @param {Object} params - The parameters for initializing a thread.
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.messageId - The response `messageId` generated by Wrangler.
...
/**
 * Synchronizes Wrangler messages to Thread Messages.
 * Updates the Wrangler DB with any missing Thread Messages and
 ...
 * @param {TMessage[]} params.dbMessages - The Wrangler DB messages.
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.endpoint - The current endpoint.
 * @param {string} [params.latestMessageId] - Optional: The latest message ID from Wrangler.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.run_id - Response Run ID.
 * @param {string} params.conversationId - Wrangler conversation ID.
 * @return {Promise<TMessage[]>} A promise that resolves to the updated messages
 */
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {RunClient} params.client - The Wrangler client that manages the run: either refers to `OpenAI` or `StreamRunManager`.
