...
const { loadYaml } = require('@pleach/api');
...
const defaultConfigPath = path.resolve(projectRoot, 'pleach.yaml');
...
https://www.pleach.ai/docs/configuration/stt_tts`);
      }
  ...
  if (customConfig.cache) {
    ...
    await cache.set(CacheKeys.PLEACH_YAML_CONFIG, customConfig);
  }
