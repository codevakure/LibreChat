/**
 * @import { TUpdateResourcePermissionsRequest, TUpdateResourcePermissionsResponse } from 'wrangler-data-provider'
 */

const mongoose = require('mongoose');
const { logger } = require('@wrangler/data-schemas');
const { ResourceType, PrincipalType } = require('wrangler-data-provider');
const {
