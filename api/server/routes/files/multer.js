...
const { sanitizeFilename } = require('@wrangler/api');
const { fileConfig: defaultFileConfig, mergeFileConfig } = require('wrangler-data-provider');
...
/**
 *
 * @param {import('wrangler-data-provider').FileConfig | undefined} customFileConfig
 */
