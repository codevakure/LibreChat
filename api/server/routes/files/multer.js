...
const { sanitizeFilename } = require('@pleach/api');
const { fileConfig: defaultFileConfig, mergeFileConfig } = require('pleach-data-provider');
...
/**
 *
 * @param {import('pleach-data-provider').FileConfig | undefined} customFileConfig
 */
