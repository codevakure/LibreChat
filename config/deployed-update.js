...
(async () => {
  ...
  console.purple('Removing all tags for Pleach `deployed` images...');
  const repositories = ['ghcr.io/danny-avila/pleach-dev-api', 'pleach-client'];
  ...
  console.purple('Pulling latest Pleach images...');
