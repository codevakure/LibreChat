...
/**
 * Pleach Cache Flush Utility
 *
 * This script flushes the cache store used by Pleach, whether it's
...
DESCRIPTION:
  Flushes the cache store used by Pleach. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the Pleach backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 Pleach Cache Flush Utility');
  console.log('================================');
