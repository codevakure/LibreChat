...
import { TooltipAnchor, Button, NewChatIcon, useMediaQuery } from '@pleach/client';
import { PermissionTypes, Permissions, QueryKeys, Constants } from 'pleach-data-provider';
...
const AgentMarketplace: React.FC<AgentMarketplaceProps> = ({ className = '' }) => {
  ...
  // Set page title
  useDocumentTitle(`${localize('com_agents_marketplace')} | Pleach`);
