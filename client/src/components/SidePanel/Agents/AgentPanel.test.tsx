...
import type { Agent } from 'pleach-data-provider';
...
jest.mock('pleach-data-provider', () => {
  const actualModule = jest.requireActual('pleach-data-provider') as any;
  return {
    ...actualModule,
    dataService: {
      updateAgent: jest.fn(),
...
jest.mock('pleach-data-provider/react-query', () => ({
...
// Import after mocks
import { dataService } from 'pleach-data-provider';
