...
jest.mock('wrangler-data-provider', () => {
  const actualModule = jest.requireActual('wrangler-data-provider') as any;
  return {
    ...actualModule,
    dataService: {
      updateAgent: jest.fn(),
...
jest.mock('wrangler-data-provider/react-query', () => ({
...
// Import after mocks
import { dataService } from 'wrangler-data-provider';
