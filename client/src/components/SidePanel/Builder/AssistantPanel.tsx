...
import { useGetModelsQuery } from 'wrangler-data-provider/react-query';
import { Spinner, useToastContext, SelectDropDown } from '@wrangler/client';
...
import type { FunctionTool, TConfig } from 'wrangler-data-provider';
...
const inputClass = cn(
  defaultTextProps,
  'flex w-full px-3 py-2 dark:border-gray-800 dark:bg-[#141618] rounded-xl mb-2',
  removeFocusOutlines,
);
